...
const Leaderboard = () => {
  ...
  const topPerformers = [
    {
      name: "Sarah Singh",
      achievement: "Most Reports Filed",
      value: "124 reports",
      period: "This month",
    },
    {
    ...
    {
      name: "Green Valley",
      achievement: "Cleanest Area",
      value: "99.2% score",
      period: "This quarter",
    },
    {
      name: "Ramesh Kushwah",
      achievement: "Best Cleaner",
      value: "95% accuracy",
      period: "All time",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Celebrating our eco-warriors who are making a difference in waste
            management. Track rankings and compete for a cleaner environment.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <EcoCard variant="gradient" className="text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Top 10 performers with exclusive rewards
            </p>
          ...
          <EcoCard variant="gradient" className="text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Fastest climbing participants this month
            </p>
            <Button variant="outline" size="sm">
              View Rising Stars
            </Button>
          ...
          <EcoCard variant="gradient" className="text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Most consistent performers over time
            </p>
            <Button variant="outline" size="sm">
              View Awards
            </Button>
