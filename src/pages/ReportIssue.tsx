...
const ReportIssue = () => {
  ...
  const issueTypes = [
    ...
    { value: "environmental-hazard", label: "Environmental Hazard", icon: TreePine },
  ...
  const recentComplaints = [
    {
      ...
      description: "Large pile of construction waste dumped illegally near the park entrance.",
    },
    {
      id: "C-455",
        ...
        <div className="max-w-2xl mx-auto">
          <EcoCard className="text-center py-12">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Your complaint has been submitted and assigned ID <strong>C-457</strong>. 
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            Your reports help improve our services.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <EcoCard>
              <h2 className="text-xl font-semibold text-foreground mb-6">Submit New Complaint</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  <Button 
                    ...
                    disabled={!issueType || !location || !description || isSubmitting}
                  >
                    {isSubmitting ? (
                      <>
          ...
          {/* Recent Complaints */}
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-4">Your Recent Reports</h2>
            <div className="space-y-4">
